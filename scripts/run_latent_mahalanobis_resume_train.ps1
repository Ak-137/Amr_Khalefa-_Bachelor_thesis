...
Requires checkpoint from end of epoch 100:
  experiments\latent_mahalanobis\models\checkpoint\latent_mahalanobis\DCASE2023T2-AE_DCASE2025T2ToyRCCar_id(0_)_seed13711\checkpoint.tar
...
$ck = Join-Path $root "experiments\latent_mahalanobis\models\checkpoint\latent_mahalanobis\DCASE2023T2-AE_DCASE2025T2ToyRCCar_id(0_)_seed13711\checkpoint.tar"
if (-not (Test-Path $ck)) {
