...
def get_argparse():
    ...
    parser.add_argument('--test_only', action='store_true', default=False,
                        help='Run test only')
    parser.add_argument('--cov_only', action='store_true', default=False,
                        help='Only run covariance calculation and finalization using already trained model checkpoint')
    
    # CORAL Residual Alignment Parameters
    parser.add_argument('--use_coral_res', type=str2bool, default=True,
                        help='Enable CORAL residual domain adaptation before Mahalanobis scoring')
    parser.add_argument('--coral_mode', type=str, default='source_to_target', choices=['source_to_target', 'pooled'],
                        help='CORAL adaptation mode')
    parser.add_argument('--coral_eps', type=float, default=1e-5,
                        help='Regularization added to the diagonal of covariances during CORAL fitting')
    parser.add_argument('--mahala_reg_lambda', type=float, default=1e-5,
                        help='Regularization added to the diagonal of covariances during Mahalanobis scoring')
