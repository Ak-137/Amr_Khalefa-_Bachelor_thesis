...
def get_argparse():
    ...
    # Top-K Anomaly Score Aggregation Parameters
    parser.add_argument('--use_topk_score', type=str2bool, default=True,
                        help='Enable Top-K anomaly score aggregation during testing')
    parser.add_argument('--topk_ratio', type=float, default=0.1,
                        help='Ratio of highest frame-level scores to keep for aggregation')
    parser.add_argument('--topk_mode', type=str, default='ratio', choices=['ratio'],
                        help='Mode for Top-K selection')
