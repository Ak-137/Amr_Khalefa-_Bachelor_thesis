...
def get_argparse():
    ...
    # MemCAE Parameters
    parser.add_argument('--use_memcae', type=str2bool, default=True,
                        help='Enable Memory-Augmented Autoencoder')
    parser.add_argument('--num_memory_slots', type=int, default=64,
                        help='Number of memory slots in the codebook')
    parser.add_argument('--memory_sparsity_weight', type=float, default=0.0,
                        help='Weight for memory sparsity regularization (entropy loss)')
